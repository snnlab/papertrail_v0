...
class TestClassroomConfig(unittest.TestCase):
    ...
    def test_round_trips(self):
        with tempfile.TemporaryDirectory() as d:
            ...
            cfg = {"serverUrl": "https://cls.example.edu", "token": "tok-abc",
                   "courseId": "SOC601"}
            submit.write_classroom_config(root, cfg)
            got = submit.read_classroom_config(root)
    ...
    def test_missing_config_returns_none(self):
        with tempfile.TemporaryDirectory() as d:
            ...
            self.assertIsNone(submit.read_classroom_config(root))
    ...
    def test_distinct_path_from_web_config(self):
        with tempfile.TemporaryDirectory() as d:
            ...
            classroom_path = submit.classroom_config_path(root)
    ...
    def test_classroom_config_does_not_leak_into_web_config(self):
        with tempfile.TemporaryDirectory() as d:
            ...
            cfg = submit.read_classroom_config(root)
    ...
    def test_written_file_is_mode_0600(self):
        ...
        with tempfile.TemporaryDirectory() as d:
            ...
            submit.write_classroom_config(
                root, {"serverUrl": "https://cls.example.edu", "token": "t",
                       "courseId": None})
            mode = submit.classroom_config_path(root).stat().st_mode & 0o777
